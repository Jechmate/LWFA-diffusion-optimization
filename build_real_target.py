...
def main():
    ...
    parser.add_argument("--experiment", type=int, default=14, help="Experiment folder in spectra/")
    parser.add_argument("--spectra-dir", default="spectra")
    parser.add_argument("--output", default="target_real_exp14_E20_P11_t40.csv")
